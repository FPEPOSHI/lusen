...
canonical: "https://lusen.oda.al/example/endpoints/v1-auth-tokens-destroy.html"
---
...
**A newer version of this operation exists**: [`DELETE /api/v2/auth/tokens/current`](/example/endpoints/v2-auth-tokens-destroy.md).
