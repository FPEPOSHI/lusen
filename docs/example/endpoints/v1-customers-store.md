...
canonical: "https://lusen.oda.al/example/endpoints/v1-customers-store.html"
---
...
**A newer version of this operation exists**: [`POST /api/v2/customers`](/example/endpoints/v2-customers-store.md).
