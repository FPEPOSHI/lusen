...
canonical: "https://lusen.oda.al/example/endpoints/v1-auth-tokens-store.html"
---
...
**A newer version of this operation exists**: [`POST /api/v2/auth/tokens`](/example/endpoints/v2-auth-tokens-store.md).
