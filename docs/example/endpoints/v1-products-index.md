...
canonical: "https://lusen.oda.al/example/endpoints/v1-products-index.html"
---
...
**A newer version of this operation exists**: [`GET /api/v2/products`](/example/endpoints/v2-products-index.md).
