...
canonical: "https://lusen.oda.al/example/endpoints/v1-orders-store.html"
---
...
**A newer version of this operation exists**: [`POST /api/v2/orders`](/example/endpoints/v2-orders-store.md).
