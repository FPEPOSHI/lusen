...
canonical: "https://lusen.oda.al/example/endpoints/v1-customers-show.html"
---
...
**A newer version of this operation exists**: [`GET /api/v2/customers/{customer}`](/example/endpoints/v2-customers-show.md).
