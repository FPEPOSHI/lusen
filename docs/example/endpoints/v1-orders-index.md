...
canonical: "https://lusen.oda.al/example/endpoints/v1-orders-index.html"
---
...
**A newer version of this operation exists**: [`GET /api/v2/orders`](/example/endpoints/v2-orders-index.md).
