...
> **Status: early — `0.7.1`.** Prose pages, route collection, FormRequest and
...
> installed — `^0.7` today. On a `0.x` version a caret pins the minor, so an
> older `^0.6` will not pick this release up.
